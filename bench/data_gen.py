...
# transforms it into tuples of (issue_url, github_url, commit_hash)
...
def create_dataset(file_path):
    ...
    # return dataset
    return dataset.loc[dataset.apply(is_issue_valid, axis=1)]
